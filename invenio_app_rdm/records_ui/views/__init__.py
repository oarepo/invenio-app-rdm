...
from .records import (
    ...
    not_found_error,
    record_container_file_download,
    record_container_file_preview,
    record_detail,
    record_export,
...
def create_blueprint(app):
    ...
    blueprint.add_url_rule(
        **create_url_rule(
            routes["record_container_file_preview"],
            default_view_func=record_container_file_preview,
        )
    )
    ...
    blueprint.add_url_rule(
        **create_url_rule(
            routes["record_container_file_download"],
            default_view_func=record_container_file_download,
        )
    )
    blueprint.add_url_rule(
        **create_url_rule(
