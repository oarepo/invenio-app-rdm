...
APP_RDM_ROUTES = {
    ...
    "record_container_file_preview": "/records/<pid_value>/preview/<path:filename>/container/<path:path>",
    "record_file_download": "/records/<pid_value>/files/<path:filename>",
    "record_container_file_download": "/records/<pid_value>/files/<path:filename>/container/<path:path>",
